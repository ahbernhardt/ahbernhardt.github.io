...
const AccentText = ({ sectionTitle }) => {
  ...
  return (
    <div className="w-[99vw] font-extrabold font-ptCond italic">
      ...
      <div className="text-8xl md:text-[13rem] lg:text-[15rem] outline-accentText absolute -left-20 md:-left-48 top-[40%] md:top-[30%] lg:top-[40%] -rotate-90">
        <motion.div
          ref={accentTextRef}
          initial="hidden"
